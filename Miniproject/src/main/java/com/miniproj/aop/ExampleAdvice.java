...
public class ExampleAdvice {
   ...
   @Before("execution(* com.miniproj.service.board.BoardServiceImpl.saveNewBoard(..))")
   public void startAOP(JoinPoint joinpoint) {
      System.out.println("==================================");
   ...
   @Around("execution(* com.miniproj.service.board.BoardServiceImpl.saveNewBoard(..))")
   public Object executionTimeLog(ProceedingJoinPoint pjp) throws Throwable {
	   System.out.println("==================================");
	   System.out.println("Start execution TimeLog AOP !!!!!!");
	   System.out.println("==================================");
